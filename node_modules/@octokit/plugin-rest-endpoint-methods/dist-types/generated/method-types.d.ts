...
export declare type RestEndpointMethods = {
    ...
    repos: {
         ...
         */
        createAnEnvironment: {
            (params?: RestEndpointMethodTypes["repos"]["createAnEnvironment"]["parameters"]): Promise<RestEndpointMethodTypes["repos"]["createAnEnvironment"]["response"]>;
            defaults: RequestInterface["defaults"];
            endpoint: EndpointInterface<{
                url: string;
            }>;
        ...
        setEnvironmentProtectionRules: {
            (params?: RestEndpointMethodTypes["repos"]["setEnvironmentProtectionRules"]["parameters"]): Promise<RestEndpointMethodTypes["repos"]["setEnvironmentProtectionRules"]["response"]>;
            defaults: RequestInterface["defaults"];
            endpoint: EndpointInterface<{
                url: string;
            }>;
