...
exports.getJobConclusions = (jobs) => github_action_helper_1.Utils.uniqueArray(jobs.filter(job => null !== job.conclusion).map(job => String(job.conclusion)));
// eslint-disable-next-line no-magic-numbers
const getLastElement = (array) => array.slice(-1)[0];
exports.getWorkflowConclusion = (conclusions) => { var _a; return _a = getLastElement(constant_1.CONCLUSIONS.filter(conclusion => conclusions.includes(conclusion))), (_a !== null && _a !== void 0 ? _a : getLastElement(constant_1.CONCLUSIONS)); };
