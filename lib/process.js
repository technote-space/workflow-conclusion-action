...
exports.getJobs = (octokit, context) => __awaiter(void 0, void 0, void 0, function* () {
    return octokit.paginate(octokit.actions.listJobsForWorkflowRun, Object.assign(Object.assign({}, context.repo), { 'run_id': Number(process.env.GITHUB_RUN_ID) }));
});
...
exports.getWorkflowConclusion = (conclusions) => { var _a; return (_a = constant_1.CONCLUSIONS.filter(conclusion => conclusions.includes(conclusion)).slice(-1)[0]) !== null && _a !== void 0 ? _a : core_1.getInput('FALLBACK_CONCLUSION'); };
